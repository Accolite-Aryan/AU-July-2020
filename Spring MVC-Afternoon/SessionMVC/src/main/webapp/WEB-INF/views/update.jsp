...
<html>
    ...
    <body>	
	    ...
	    <a href="/SessionMVC/StudentList" class="btn">Student List</a>
	    </div>
	    <div class="body">
		   	 <h1 class="w-100">Update Student</h1>
	        
	        <form action="/SessionMVC/update" method="post">
	        	...
	        	<input type="text" name="lastname"  value="${lastname}"  class="textbox"  /><br>
	        	<label>Department</label><br>
	        	<input type="text" name="dept"  value="${dept}"  class="textbox" /><br>
	        	<input type="submit" value="Update Student" class="btnsbmt"/>
	    		<a href="/SessionMVC/" class="btnsbmt">Cancel</a>
	        </form>
	    </div>
